...
TEAM_FILE="/tmp/swarm-local-20260315-232322-26058/planner/.swarm/current-team.txt"
if [ ! -f "$TEAM_FILE" ]; then
...
echo ""
echo "   Document needed changes in /tmp/swarm-local-20260315-232322-26058/planner/.swarm/cross-team-requests.md:"
echo "   - File: $FILE"
